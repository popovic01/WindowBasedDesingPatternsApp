...
public class Rectangle extends SurfaceShape {
	...
	public int compareTo(Object o) {
		if (o instanceof Rectangle) {
			if (this.height == ((Rectangle)o).getHeight())
				if (this.width == ((Rectangle)o).getWidth())
					if (this.upperLeftPoint.getX() == ((Rectangle)o).getUpperLeftPoint().getX())
						if (this.upperLeftPoint.getY() == ((Rectangle)o).getUpperLeftPoint().getY())
							return 0;
		}
		return -1;
	}
	...
	public String toString() {
		...
		return upperLeftPoint + "," + width + "," + height;
	}
	
	public Rectangle clone() {
		Rectangle rectangle = new Rectangle();
		//kao parametar se prima pravougaonik koji setujemo
